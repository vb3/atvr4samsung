"""ChaCha20-Poly1305 transparent encryption layer. Origin: pyatv v0.18.0 (MIT), adapted."""
...
class Chacha20Cipher:
    ...
    def out_nonce(self) -> bytes:
        """Counter nonce the next implicit encrypt call will consume."""
    ...
    def in_nonce(self) -> bytes:
        """Counter nonce the next implicit decrypt call will consume."""
        nonce_length = self._nonce_length
...
class Chacha20Cipher8byteNonce(Chacha20Cipher):
    """ChaCha20-Poly1305 with the Companion/HAP 8-byte counter nonce layout.
